-- สร้างฐานข้อมูล testGemini
CREATE DATABASE IF NOT EXISTS testGemini;
...
-- สร้างตาราง data_proc_requirements
-- CREATE TABLE IF NOT EXISTS data_proc_requirements (
...
-- สร้างตาราง observing_program
CREATE TABLE IF NOT EXISTS observing_program (
...
('1', 'Xenon', '5.5', 'S', 'MaunaKeaSkyEmission', '2', 'GSZ', '12', '2', '0', 'REFLECTIVE_CONVERGING_BEAM', 1);
-- ('2', 'Argon', '5.5', 'S', 'MaunaKeaSkyEmission', '1', 'GSZ', '12', '2', '0', 'REFLECTIVE_CONVERGING_BEAM', 0),
-- ('3', 'Xenon', '5.5', 'S', 'MaunaKeaSkyEmission', '2', 'GSZ', '12', '2', '0', 'REFLECTIVE_CONVERGING_BEAM', 1);
